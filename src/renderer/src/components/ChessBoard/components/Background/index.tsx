  ...
  return (
    <>
      ...
      <g className="pointer-events-none select-none">
        ...
        {/* Red side */}
        <line x1="100" y1="670" x2="100" y2="730" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="100" y1="700" x2="130" y2="700" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="100" y1="670" x2="100" y2="730" stroke="#334155" strokeWidth="8" />
        <line x1="100" y1="700" x2="130" y2="700" stroke="#334155" strokeWidth="8" />

        <line x1="300" y1="670" x2="300" y2="730" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="270" y1="700" x2="330" y2="700" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="300" y1="670" x2="300" y2="730" stroke="#334155" strokeWidth="8" />
        <line x1="270" y1="700" x2="330" y2="700" stroke="#334155" strokeWidth="8" />

        <line x1="500" y1="670" x2="500" y2="730" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="470" y1="700" x2="530" y2="700" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="500" y1="670" x2="500" y2="730" stroke="#334155" strokeWidth="8" />
        <line x1="470" y1="700" x2="530" y2="700" stroke="#334155" strokeWidth="8" />

        <line x1="700" y1="670" x2="700" y2="730" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="670" y1="700" x2="730" y2="700" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="700" y1="670" x2="700" y2="730" stroke="#334155" strokeWidth="8" />
        <line x1="670" y1="700" x2="730" y2="700" stroke="#334155" strokeWidth="8" />

        <line x1="900" y1="670" x2="900" y2="730" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="870" y1="700" x2="900" y2="700" stroke="#0ea5e9" strokeWidth="14" />
        ...
        <line x1="200" y1="770" x2="200" y2="830" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="170" y1="800" x2="230" y2="800" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="200" y1="770" x2="200" y2="830" stroke="#334155" strokeWidth="8" />
        <line x1="170" y1="800" x2="230" y2="800" stroke="#334155" strokeWidth="8" />

        <line x1="800" y1="770" x2="800" y2="830" stroke="#0ea5e9" strokeWidth="14" />
        <line x1="770" y1="800" x2="830" y2="800" stroke="#0ea5e9" strokeWidth="14" />
